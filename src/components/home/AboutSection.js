      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center gap-8">
          <div className="md:w-1/2 mb-10 md:mb-0 md:pr-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 md:mb-6 text-gray-800">About Spanex Sciences</h2>
            ...
            <div className="mt-6 md:mt-8">
              <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-3 md:mb-4">Our Core Offerings</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
                <div className="flex items-start p-2 hover:bg-gray-50 rounded-lg transition-colors">
                  <div className="p-2 sm:p-3 rounded-full mr-3 md:mr-4" style={{ backgroundColor: 'var(--light-mint)' }}>
