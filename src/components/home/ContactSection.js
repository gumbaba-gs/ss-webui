      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 md:pr-8 mb-10 md:mb-0">
            ...
            <h3 className="text-2xl font-bold mt-10 mb-6 text-text">Connect With Us</h3>
            <div className="flex space-x-4">
              <button className="bg-primary hover:bg-primary/90 text-background w-10 h-10 rounded-full flex items-center justify-center transition-colors">
                <i className="fab fa-linkedin-in"></i>
              </button>
              <button className="bg-secondary hover:bg-secondary/90 text-background w-10 h-10 rounded-full flex items-center justify-center transition-colors">
                <i className="fab fa-twitter"></i>
              </button>
              <button className="bg-error hover:bg-error/90 text-background w-10 h-10 rounded-full flex items-center justify-center transition-colors">
                <i className="fab fa-youtube"></i>
              </button>
              <button className="bg-accent hover:bg-accent/90 text-background w-10 h-10 rounded-full flex items-center justify-center transition-colors">
                <i className="fas fa-envelope"></i>
              </button>
            </div>
          </div>

          <div className="md:w-1/2 bg-surface p-8 rounded-lg shadow-md">
            ...
            <form className="contact-form" onSubmit={handleSubmit}>
              ...
              <button 
                type="submit" 
                className="mt-6 w-full bg-primary hover:bg-primary/90 text-background font-bold py-3 px-4 rounded transition duration-300"
              >
                Send Message
              </button>
            </form>
